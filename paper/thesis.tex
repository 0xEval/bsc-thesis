...
\lstinputlisting[belowcaptionskip=0pt,float=h,language=C,firstline=5,label=lst_overflow,caption=Buffer
...
\textbf{\textit{Example:}} \textit{stack buffer overflow}~\cite{one_stacksmashing_1996}. When invoking or exiting a standard C function,
...
of exec\_shell we need to fill the buffer with $100$ bytes, overwrite
